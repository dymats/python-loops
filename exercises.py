...
cars = ['Ferrari', 'BMW', 'Mercedes', 'Tesla', 'Porsche' ]
for car in cars:
...
#Your job is to create a function that will loop through the rappers list and place all the odd indexed items in a list named west_side and all the even indexed items in a list named east_side. Print your results.
